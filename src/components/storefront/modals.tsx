      ...
      {mode !== "otp" && !pendingChange && (
        <div className="mb-3">
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2.5 rounded-pill border-2.5 border-ink bg-white py-2 px-4 font-display text-[13px] font-extrabold text-ink shadow-hard-2 hover:bg-[#F9F7F2] active:scale-[0.98] transition-all cursor-pointer disabled:opacity-50"
          >
          ...
          <div className="mt-3 flex items-center justify-center gap-3 text-mute">
            <hr className="w-full border-ink/20 border-t-2 border-dashed" />
            <span className="text-[10px] font-extrabold uppercase tracking-wider text-mute">or</span>
            <hr className="w-full border-ink/20 border-t-2 border-dashed" />
          </div>
        </div>
      )}
