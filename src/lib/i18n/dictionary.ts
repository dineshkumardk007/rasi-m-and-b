...
const en = {
  ...
  "track.quickSelect": "Or pick a recent order:",
  ...
  "baby.dobLabel": "Baby's date of birth",
  "baby.dobHelp": "We'll suggest what fits their age — and send a birthday treat 🎂",
  "baby.save": "Save",
  "baby.remove": "Remove",
  "baby.saved": "Saved! We'll keep suggestions age-perfect 👶",
  "baby.removed": "Baby birthday removed.",
  "baby.ageNow": "{age} old",
  "baby.pickedFor": "Picked for your {age} old 👶",
  "baby.nextStage": "Coming up in {months} month(s) — get ready for the next stage ✨",
  "baby.birthdayMonth": "🎂 It's birthday month! Use code {code} for {percent}% off",
...
const ta: Record<TranslationKey, string> = {
  ...
  "track.cta": "கண்காணி",
  "track.quickSelect": "அல்லது சமீபத்திய ஆர்டரைத் தேர்ந்தெடுக்கவும்:",
  ...
  "baby.dobLabel": "குழந்தையின் பிறந்த தேதி",
  "baby.dobHelp": "வயதுக்கு ஏற்றவற்றைப் பரிந்துரைப்போம் — பிறந்தநாள் பரிசும் உண்டு 🎂",
  "baby.save": "சேமி",
  "baby.remove": "நீக்கு",
  "baby.saved": "சேமிக்கப்பட்டது! 👶",
  "baby.removed": "பிறந்த தேதி நீக்கப்பட்டது.",
  "baby.ageNow": "{age}",
  "baby.pickedFor": "{age} குழந்தைக்காக தேர்ந்தெடுத்தவை 👶",
  "baby.nextStage": "{months} மாதத்தில் அடுத்த கட்டம் ✨",
  "baby.birthdayMonth": "🎂 பிறந்த மாதம்! {code} குறியீட்டில் {percent}% தள்ளுபடி",
  "baby.birthdaySoon": "🎂 {days} நாட்களில் பிறந்தநாள் — பரிசு காத்திருக்கிறது",
  "baby.graduated": "உங்கள் குழந்தை எங்கள் வயது வழிகாட்டியைத் தாண்டிவிட்டது 💛",
